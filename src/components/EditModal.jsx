      ...
      >
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Modifica la información y configuración de esta tarea.
                </p>
              </div>
            </div>
        ...
        <div className="max-h-[75vh] overflow-y-auto p-6">
          ...
          <section>
            <div className="mb-4">
              ...
              <p className="mt-1 text-xs text-slate-500">
                Actualiza el título y los detalles de la tarea.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Describe los detalles o instrucciones de la tarea..."
                  rows={4}
          ...
          <section className="mt-6 rounded-2xl border border-slate-200 bg-slate-50 p-4">
            <div className="mb-4">
              ...
              <p className="mt-1 text-xs text-slate-500">
                Define cómo se organizará y asignará la tarea.
              </p>
            </div>
        ...
        <div className="flex flex-col-reverse gap-3 border-t border-slate-200 bg-slate-50 px-6 py-4 sm:flex-row sm:justify-end">
          <button
            type="button"
            onClick={onClose}
            className="rounded-xl border border-slate-200 bg-white px-5 py-3 text-sm font-semibold text-slate-600 transition hover:bg-slate-100 hover:text-slate-900"
          >
            Cancelar
          </button>
